...
create table Employees (employee_id int, first_name string, last_name string, email string, phone_number string, hire_date date, job_id int, salary decimal (10,3) , manager_id int, department_id int)
...
CREATE TABLE jobs (job_id INT , job_title string,  min_salary DECIMAL (8, 2), max_salary DECIMAL (8, 2))
